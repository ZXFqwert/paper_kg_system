...
class GraphRAG:
    ...
    def __post_init__(self):
        ...
        # Amazon Bedrock support removed to eliminate dependencies
        if self.using_amazon_bedrock:
            raise NotImplementedError(
                "Amazon Bedrock support has been removed to eliminate aioboto3 dependency. "
                "Please use OpenAI or Azure OpenAI instead."
            )
